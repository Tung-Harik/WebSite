...
<body class="bg-body-tertiary">
  ...
  <%-- Controller set listPath = req.getServletPath(); fallback: /user/trangchu --%>
  <c:set var="listPath" value="${empty requestScope.listPath ? '/user/trangchu' : requestScope.listPath}"/>
  <%-- Build base URL có contextPath tự động --%>
  ...
  <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mt-4 gap-3">
    ...
    <nav aria-label="Product pagination">
      <ul class="pagination mb-0">
        ...
        <%-- Các trang trong khoảng start..end --%>
        ...
        <%-- Nếu end < totalPages: hiện … + trang cuối --%>
        <c:if test="${end < totalPages}">
          <li class="page-item disabled"><span class="page-link">…</span></li>
